...
function PaymentPage() {
  ...
  const paymentOptions = [
    {
      ...
      imageToggle: '/images/icon-card-white.png',
    },
    {
 ...
 const [phone, setPhone] = useState('');
  ...
  <div className="fixed inset-0 z-50 flex items-center justify-center bg-black bg-opacity-50">
    <div className="bg-white w-full max-w-sm p-6 rounded-xl relative animate-slide-down">
            {/* Close Button */}
            <button
      ...
      <div className="flex items-center border rounded-md overflow-hidden focus-within:ring-2 focus-within:ring-[#F0AB50] mb-2">
        {/* Flag and +91 */}
        <div className="flex items-center px-3 bg-gray-100 text-gray-700 whitespace-nowrap">
          🇮🇳 +91
        </div>
  ...
  return (
    <label
      key={option.value}
      className={`cursor-pointer flex text-xl items-center space-x-4 px-4 py-3 border rounded-xl transition-all duration-200
        ${isSelected
          ? 'bg-[#F0AB50] text-white border-[#F0AB50]'
          : 'bg-white text-[#DA4F46] border-[#F0AB50] hover:border-[#F0AB50]'}
      `}
